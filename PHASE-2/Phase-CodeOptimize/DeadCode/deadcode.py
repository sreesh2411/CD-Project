...
def constantFolding(lines, blocks):
    ...
    print()
    print(bcolors.WARNING+"ICG after Constant Folding and Constant Propogation (Quadruple):"+bcolors.ENDC)
    #print("___________________________")
    print()
    k = 0
    for i in lines:
...
print()
print(bcolors.WARNING+"Original ICG:"+bcolors.ENDC)
lines = fin.readlines()
print()
...
print(bcolors.WARNING+"ICG after Dead Code Elimination:"+bcolors.ENDC)
#print("_____________________")
print()
